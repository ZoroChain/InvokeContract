    ...
    class LocalTest_MemPool : IExample
    {
        ...
        private void Test()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("3.RemoveUnverified");
        ...
        private void RemoveUnverified()
        {
            ...
            {
                IEnumerable<Transaction> unverfied = mempool.TakeUnverifiedTransactions(step);
        ...
        private Transaction MakeTransaction(Random rnd)
        {
            ...
            using (ScriptBuilder sb = new ScriptBuilder())
            {
                ...
                InvocationTransaction tx = new InvocationTransaction
                {
                    ...
                    Script = sb.ToArray(),
                    GasPrice = price,
                    GasLimit = Fixed8.FromDecimal((decimal)4.5),
